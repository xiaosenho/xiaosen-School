package com.xiaosenho.generator;
...
public class ContentCodeGenerator {
	...
	//数据库账号
	private static final String DATA_SOURCE_USER_NAME  = "xiaosenho";
	//数据库密码
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/xiaosen-school-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://106.54.193.108:3306/xs-school-" + SERVICE_NAME
